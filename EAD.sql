...
BEGIN
	IF VERIFICAR_SE_REGISTRO_EXISTE(CODIGO_QUESTAO, 'QUESTAO') IS FALSE THEN
		RAISE EXCEPTION 'ESSA QUESTAO NÃO EXISTE, INSIRA UM COD_QUESTAO VALIDO!';
	ELSE
...
AS $$
BEGIN
	IF VERIFICAR_SE_REGISTRO_EXISTE(CODIGO_PROFESSOR, 'PROFESSOR') IS FALSE THEN
		RAISE EXCEPTION 'ESSE PROFESSOR NÃO EXISTE, INSIRA UM COD_PROFESSOR VALIDO!';
	END IF;
